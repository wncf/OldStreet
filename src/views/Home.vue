  ...
  <div class="home">
    ...
    <div class="bottom">
      <van-tabbar class="bottom-content" v-model="active" fixed>
        <van-tabbar-item name="home" to="/home" icon="wap-home-o">首页

        </van-tabbar-item>
        <van-tabbar-item name="family" to="family" icon="apps-o">分类

        </van-tabbar-item>
        <van-tabbar-item name="cart" to="cart" icon="cart-o">购物车

        </van-tabbar-item>
        <van-tabbar-item name="user" to="user" icon="user-o">我的
